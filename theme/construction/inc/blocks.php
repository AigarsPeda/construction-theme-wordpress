	...
	wp_localize_script(
		...
		array(
			...
			'strings'     => array(
				...
				'clickToEdit'  => __( 'One card = one project (all languages). Click to edit translations and images.', 'construction' ),
				'languages'    => __( 'Languages', 'construction' ),
				'title'        => __( 'Title', 'construction' ),
				'description'  => __( 'Description', 'construction' ),
				...
				'openFull'     => __( 'Open full editor', 'construction' ),
